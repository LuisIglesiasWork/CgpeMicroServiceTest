...
namespace Cgpe.Du.CrossCuttings
{
    ...
    public class DuSecurityManager
    {
        ...
        public void CheckPermission(params string[] claimIds)
        {
        ...
        public void CheckPermission(string generalClaimId, string particularClaimId, string associationId)
        {
            ...
            if (this.LoggedUser != null)
            {
                ...
                else if (this.LoggedUser.Association != null && associationId != null)
                {
                    if (this.LoggedUser.DirectoryRoles.Any(r => r.Claims.Any(c => c.ClaimId == particularClaimId))
                            && this.LoggedUser.Association.AssociationId == associationId)
                    {
                        authorized = true;
                    }
                }
        ...
        public void CheckPermission(string particularClaimId, string associationId)
        {
            bool authorized = false;

            if (this.LoggedUser != null)
            {
                if (this.LoggedUser.Association != null && associationId != null)
                {
                    if (this.LoggedUser.DirectoryRoles.Any(r => r.Claims.Any(c => c.ClaimId == particularClaimId))
                            && this.LoggedUser.Association.AssociationId == associationId)
                    {
        ...
        public void CheckPermission(string claimId)
        {
        ...
        private string GetPermissionExceptionMessage(params string[] claimIds)
        {
