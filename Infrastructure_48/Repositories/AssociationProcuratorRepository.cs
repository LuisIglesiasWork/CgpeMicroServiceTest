...
namespace Cgpe.Du.Infrastructure
{
    public class AssociationProcuratorRepository : IAssociationProcuratorRepository
    {
        ...
        public string Create(AssociationProcurator newDomainAssociationProcurator)
        {
            return this.UpsertAssociationProcurator(newDomainAssociationProcurator, true);
        }

        public string Update(AssociationProcurator newDomainAssociationProcurator)
        {
            return this.UpsertAssociationProcurator(newDomainAssociationProcurator, false);
        }

        public AssociationProcurator Read(string associationProcuratorId)
        {
        ...
        private AssociationProcuratorEntity ReadAssociationProcuratorEntity(string associationProcuratorId)
        {
            try
            {
        ...
        public string UpsertAssociationProcurator(AssociationProcurator newDomainAssociationProcurator, bool isNew)
        {
            ...
            var query = uow.DbContext.AssociationProcurators
              ...
              //  && ap.CreationStateId == CreationStateEnum.Precreated
               ...
               // && ap.Procurator.CreationStateId == CreationStateEnum.Accepted
                && ap.CreatorUser != null
                && ap.CreatorUser.AssociationId != null).OrderByDescending(ap => ap.CreationRequestDate).AsQueryable();
        ...
        public CountResultByAssociation Count(string associationId)
        {
