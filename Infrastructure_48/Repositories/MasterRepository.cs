...
namespace Cgpe.Du.Infrastructure
{
    ...
    public class MasterRepository : IMasterRepository
    {
        ...
        public List<Organization> GetOrganizations(string organizationTypeId, bool includeInactive = false)
        {
        ...
        public List<Organ> GetOrgans(string organizationId, bool includeInactive = false)
        {
