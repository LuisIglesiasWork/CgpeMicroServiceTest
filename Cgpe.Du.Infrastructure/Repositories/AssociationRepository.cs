...
namespace Cgpe.Du.Infrastructure
{
    ...
    public class AssociationRepository : IAssociationRepository
    {
        ...
        private AssociationEntity ReadAssociationEntity(Guid associationId)
        {
        ...
        public Association Read(Guid associationId)
        {
        ...
        public AssociationEntity ReadAssociationEntity(Guid? associationId, string cif)
        {
            AssociationEntity entity =
                ...
                .Include("Contacts.ContactType")
                .Where(a =>
                    (associationId == null || !associationId.HasValue || a.AssociationId == associationId)
        ...
        public bool CheckIfAssociationIdDocumentExists(string cif, Guid? associationId)
        {
            AssociationEntity assoEntity =
               uow.DbContext.Associations
                   .Where(a => a.Cif == cif && (associationId == null || !associationId.HasValue || associationId.Value != a.AssociationId)).FirstOrDefault();
