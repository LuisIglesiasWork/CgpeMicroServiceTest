...
namespace Cgpe.Du.Infrastructure
{
    ...
    public class IdentificationDocumentFileEfMap
    {
        ...
        public void Map(IdentificationDocumentFile source, IdentificationDocumentFileEntity target, Guid? procuratorId, bool isNew = false)
        {
            if (isNew)
            {
                source.IdentificationDocumentId = Guid.NewGuid();
            }
