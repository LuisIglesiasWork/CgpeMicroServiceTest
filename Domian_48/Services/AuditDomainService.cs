...
namespace Cgpe.Du.Domain
{
    ...
    public class AuditDomainService
    {
        ...
        public List<Audit> GetObjectAuditHistory(string objectId)
        {
            return this.auditRepository.ReadObjectHistory(objectId);
        }

        public void AuditOperation(string before, string after, string signedData, string operation, string relatedTreeId, string relatedTreeType)
        {
