...
namespace Cgpe.Du.Domain
{
    ...
    public class MinistryIntegrationDomainService
    {
        ...
        public int SyncInitTransaction(string transactionId, DateTime dateFrom, DateTime dateTo, String associationCode, bool isInitialLoad)
        {
            int result = 0;
            try
            {
        ...
        public List<Procurator> SyncGetPageOfRecords(string TransactionId, int pageSize)
        {
            if (pageSize <= 0)
        ...
        public void SyncMarkProcessedPage(string SyncId, bool proccesed, List<string> changeIds)
        {
            this.procuratorRepository.SyncMarkProcessedPage(SyncId, proccesed, changeIds);
            this.uow.Commit();
        }

        public void SyncMarkAcceptedPage(string SyncId, bool accepted, List<string> procuratorsWithErrorsNifs)
        {
        ...
        public void SyncRegisterSentNifs(string syncId, List<string> processedWithErrorNifs)
        {
        ...
        public IntegrationWorkflow GetIntegrationWorkflowInstance(string instanceId)
        {
