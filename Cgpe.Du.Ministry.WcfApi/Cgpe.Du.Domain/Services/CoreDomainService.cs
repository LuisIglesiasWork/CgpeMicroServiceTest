...
namespace Cgpe.Du.Domain
{
    ...
    public class CoreDomainService
    {
        ...
        public Guid CreateProcurator(Procurator procurator)
        {
        ...
        public Guid PrecreateProcurator(Procurator procurator)
        {
        ...
        public Guid PrecreateAssociationProcurator(AssociationProcurator associationProcurator)
        {
            DateTime now = DateTime.UtcNow;
        ...
        public Guid AcceptAssociationProcurator(AssociationProcurator associationProcurator)
        {
            DateTime now = DateTime.UtcNow;
        ...
        public Guid RejectAssociationProcurator(AssociationProcurator associationProcurator)
        {
            DateTime now = DateTime.UtcNow;
        ...
        public Guid FixAssociationProcurator(AssociationProcurator associationProcurator)
        {
            DateTime now = DateTime.UtcNow;
        ...
        public Procurator ReadProcurator(Guid procuratorId)
        {
            return this.procuratorRepository.Read(procuratorId);
        }

        public AssociationProcurator ReadAssociationProcurator(Guid associationProcuratorId)
        {
            return this.associationProcuratorRepository.Read(associationProcuratorId);
        }

        public Guid UpdateProcurator(Procurator procurator)
        {
            if (procurator.AssociationsProcurators != null)
            {
                foreach (AssociationProcurator assoProc in procurator.AssociationsProcurators)
        ...
        public Guid AcceptProcurator(Procurator procurator)
        {
            DateTime now = DateTime.UtcNow;
        ...
        public Guid RejectProcurator(Procurator procurator)
        {
            DateTime now = DateTime.UtcNow;
        ...
        public Guid FixProcurator(Procurator procurator)
        {
            DateTime now = DateTime.UtcNow;
        ...
        public List<Procurator> GetRejectedProcuratorsPage(Guid? associationId,
        ...
        public Association ReadAssociation(Guid associationId)
        {
        ...
        public bool CheckIfAssociationIdDocumentExists(string cif, Guid? associationId)
        {
